...
//                    if (swipeBackListener != null) swipeBackListener.onFinish();
                    finish();
                }
            }
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (swipeBackListener != null) {
                swipeBackListener.onViewPositionChanged(fractionAnchor, fractionScreen, draggingOffset);
            }
        }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (isBack && swipeBackListener != null) swipeBackListener.onFinish();
